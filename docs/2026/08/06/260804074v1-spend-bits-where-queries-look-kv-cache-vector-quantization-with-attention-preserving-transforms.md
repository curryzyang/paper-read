...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.04074v1) · [PDF](https://arxiv.org/pdf/2608.04074v1)

## TLDR
NOVA-KV proposes an attention-preserving transform coding approach for KV cache quantization that derives closed-form optimal transforms and MSE-optimal vector quantizers, recovering most long-context retrieval accuracy lost by scalar quantization at 2 bits per element with comparable throughput.
