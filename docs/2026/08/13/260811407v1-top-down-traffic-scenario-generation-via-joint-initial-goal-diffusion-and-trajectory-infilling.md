...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.11407v1) · [PDF](https://arxiv.org/pdf/2608.11407v1)

## TLDR
TrafficDiffuser generates realistic, interpretable top-down traffic scenarios by jointly diffusing agents' initial and goal states, reframing trajectory generation as a simple infilling problem, and improving agent initialization accuracy on Argoverse 2.
