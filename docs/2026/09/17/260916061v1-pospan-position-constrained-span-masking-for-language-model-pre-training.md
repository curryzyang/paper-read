...
- 链接：[arXiv / Source](http://arxiv.org/abs/2609.16061v1) · [PDF](https://arxiv.org/pdf/2609.16061v1)

## TLDR
POSPAN introduces a general position-constrained span masking framework that combines span-length and position-distance distributions to improve masked language model pre-training, consistently outperforming span-length-only and vanilla MLM methods.
