...
- 机构：PATH, UCL
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.07766v1) · [PDF](https://arxiv.org/pdf/2607.07766v1)

## TLDR
This paper proposes "alignment plausibility" as a new regulatory standard for AI in healthcare, organizing safety around three levels—value specification, training, and oversight—that mirror clinical practice to ensure LLMs are structurally safe and beneficial.
