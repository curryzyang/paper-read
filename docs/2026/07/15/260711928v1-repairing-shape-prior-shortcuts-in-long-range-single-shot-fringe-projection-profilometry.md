...
- 机构：Iowa State University, University of Georgia
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.11928v1) · [PDF](https://arxiv.org/pdf/2607.11928v1)

## TLDR
PhiCalNet repairs the shape-prior shortcut in single-shot fringe projection profilometry by outputting wrapped phase and using a fixed differentiable calibration layer, reducing object MAE 3.3x to 4.46 mm.
