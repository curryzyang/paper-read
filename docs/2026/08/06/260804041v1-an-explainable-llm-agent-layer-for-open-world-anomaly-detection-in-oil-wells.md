...
- 机构：Federal University of Alagoas
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.04041v1) · [PDF](https://arxiv.org/pdf/2608.04041v1)

## TLDR
This paper introduces an explainable LLM agent layer downstream of an open-world anomaly detection pipeline that provides sensor-grounded justifications, validates or critiques upstream classifications, and names novel anomaly clusters, closing the explainability gap for operational oil well monitoring.
