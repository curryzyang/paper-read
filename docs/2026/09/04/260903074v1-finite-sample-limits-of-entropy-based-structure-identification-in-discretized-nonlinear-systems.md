...
- 匹配度：4.1/10
- 来源：arxiv
- 作者：Pratishtha Shukla, James Nutaro
- 机构：Oak Ridge National Laboratory
- 链接：[arXiv / Source](http://arxiv.org/abs/2609.03074v1) · [PDF](https://arxiv.org/pdf/2609.03074v1)

## TLDR
Entropy-based structure identification in discretized nonlinear systems is fundamentally limited by a resolution–stochasticity ratio: below this threshold it consistently recovers causal inputs, but above it it loses discriminative power regardless of sample size, while incurring a closed-form excess prediction risk relative to MSE-based selection.
