...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.21387v1) · [PDF](https://arxiv.org/pdf/2608.21387v1)

## TLDR
The paper presents an intelligent companion robot for elderly-care facilities that integrates active visual human-following, LLM-driven speech interaction for intent understanding and task execution, and VLM-based safety monitoring for fall detection, enabling continuous companionship, natural interaction, and timely emergency response.
