...
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.14125v1) · [PDF](https://arxiv.org/pdf/2607.14125v1)

## TLDR
CARPRT proposes a class-aware zero-shot prompt reweighting method for vision-language models that adjusts prompt weights per class by estimating class-specific relevance, outperforming existing class-independent reweighting approaches.
