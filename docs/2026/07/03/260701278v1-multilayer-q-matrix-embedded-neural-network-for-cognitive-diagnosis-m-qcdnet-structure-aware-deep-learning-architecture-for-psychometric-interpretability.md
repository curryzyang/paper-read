...
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.01278v1) · [PDF](https://arxiv.org/pdf/2607.01278v1)

## TLDR
M-QCDNet embeds the Q-matrix as a structural prior across multiple neural network layers, using regularization and novel alignment-based metrics to ensure that latent skill representations remain both predictive and psychometrically interpretable for cognitive diagnosis.
