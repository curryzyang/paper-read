...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.13652v1) · [PDF](https://arxiv.org/pdf/2608.13652v1)

## TLDR
TLDR: The paper introduces ORCA, a two-stage anomaly detection framework that uses supervised contrastive learning to build a physics-interpretable embedding space before running an autoencoder, improving both sensitivity and interpretability of new physics searches at the HL-LHC.
