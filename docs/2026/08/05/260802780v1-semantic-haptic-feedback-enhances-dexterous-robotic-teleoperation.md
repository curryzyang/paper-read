...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.02780v1) · [PDF](https://arxiv.org/pdf/2608.02780v1)

## TLDR
Semantic haptic feedback—using abstract pneumatic and vibrotactile patterns to convey robot-state events instead of replicating raw contact forces—significantly improves bimanual dexterous teleoperation performance, reduces workload, and increases operator situational awareness compared to sensory haptic and visual feedback.
