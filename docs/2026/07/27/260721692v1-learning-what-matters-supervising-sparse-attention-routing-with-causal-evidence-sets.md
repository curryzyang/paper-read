...
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.21692v1) · [PDF](https://arxiv.org/pdf/2607.21692v1)

## TLDR
This paper demonstrates that training sparse attention selectors on causal evidence sets—the context that actually affects a model's predictions—significantly outperforms training on attention patterns, because attention often reflects irrelevant or outdated information and does not capture true causal dependence.
