...
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.28696v1) · [PDF](https://arxiv.org/pdf/2607.28696v1)

## TLDR
CALCoDe, a post-hoc reliability layer for frozen medical vision-language models, adaptively identifies and protects disease classes at risk of undercoverage under clinical shift and achieves both marginal and worst-class accepted coverage of 0.95 across all tested dermatology-shift and backbone settings.
