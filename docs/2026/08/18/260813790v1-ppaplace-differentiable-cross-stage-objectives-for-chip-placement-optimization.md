...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.13790v1) · [PDF](https://arxiv.org/pdf/2608.13790v1)

## TLDR
PPAPlace introduces a differentiable, timing-driven placement surrogate trained on post-global-routing labels—combining graph attention and spatial convolution—that improves post-route WNS and TNS by 22% and 51% over the hierarchical baseline through co-optimization and refinement.
