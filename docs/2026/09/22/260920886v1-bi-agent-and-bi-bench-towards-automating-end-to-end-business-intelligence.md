...
- 机构：UIUC, Microsoft, Microsoft Research
- 链接：[arXiv / Source](http://arxiv.org/abs/2609.20886v1) · [PDF](https://arxiv.org/pdf/2609.20886v1)

## TLDR
This paper introduces BI-Bench, a benchmark for end-to-end business intelligence built from real-world BI projects, and BI-Agent, a tool-augmented, post-trained LLM agent that decomposes BI workflows into search, join, and transform subtasks, achieving up to 40 percentage-point gains over vanilla LLMs and up to 30 points after SFT/RL.
