...
- 机构：Norwegian University of Life Sciences, University of Klagenfurt
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.01306v1) · [PDF](https://arxiv.org/pdf/2607.01306v1)

## TLDR
PACE is a modular neuro-symbolic framework that integrates neural prediction with Answer Set Programming constraints to generate feasible, minimal counterfactual explanations that respect domain knowledge, as demonstrated on the Adult Income dataset.
