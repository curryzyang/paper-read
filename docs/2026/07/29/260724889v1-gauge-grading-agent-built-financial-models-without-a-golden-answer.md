...
- 机构：University of Adelaide, Foresight Fund, Peking University, Tsinghua University, StepFun, Finstep, Shanghai Jiao Tong University, National University of Singapore
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.24889v1) · [PDF](https://arxiv.org/pdf/2607.24889v1)

## TLDR
GAUGE introduces a benchmark that evaluates agent-built financial models against observed analyst practice rather than a single correct answer, revealing that current agents are substantially stronger at model construction than valuation judgment.
