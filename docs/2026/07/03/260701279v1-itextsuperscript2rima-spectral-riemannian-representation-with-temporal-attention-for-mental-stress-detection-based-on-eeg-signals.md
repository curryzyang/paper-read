...
- 机构：Capital Normal University, Karlsruhe Institute of Technology
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.01279v1) · [PDF](https://arxiv.org/pdf/2607.01279v1)

## TLDR
I\textsuperscript{2}RiMA introduces a frequency-aware Riemannian manifold attention network that constructs per-frequency spatial covariance matrices and uses intra-inter slice attention to capture both local spectral and global temporal dependencies, achieving state-of-the-art cross-subject EEG stress detection.
