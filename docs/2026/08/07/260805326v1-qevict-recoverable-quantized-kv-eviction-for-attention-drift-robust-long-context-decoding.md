...
- 机构：Indian Institute of Technology Delhi, Indian Institute of Technology Roorkee
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.05326v1) · [PDF](https://arxiv.org/pdf/2608.05326v1)

## TLDR
QEvict introduces a three-tier recoverable KV-cache management scheme that, instead of permanently evicting low-attention tokens, stores them in a quantized recoverable tier from which they can be dequantized and promoted when attention drifts back, improving long-context decoding under fixed memory budgets.
