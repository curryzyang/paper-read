...
- 链接：[arXiv / Source](http://arxiv.org/abs/2609.13149v1) · [PDF](https://arxiv.org/pdf/2609.13149v1)

## TLDR
BudgetBench introduces a reusable budget-tiered protocol and harness that sweeps per-call input-token budgets (2K–32K) to evaluate memory strategies in local LLM agents, recording quality, utilization, latency, and budget-violation rates, and uses pilot studies to show that fixed-budget evaluation exposes compliance failures and non-monotonic quality curves hidden by single-budget testing.
