...
## TLDR
NightVision recovers LLM hidden dimension, depth, and parameter count from restrictive APIs that expose only a single log probability and response timing, achieving 23% average error on hidden dimension across 32 open-source models.
