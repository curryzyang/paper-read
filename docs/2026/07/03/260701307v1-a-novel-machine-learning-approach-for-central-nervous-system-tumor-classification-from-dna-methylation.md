...
- 匹配度：1.5/10
- 来源：arxiv
- 作者：Paulo R. Ferreira, Lucas Coutinho Freitas, Laís dos Santos Gonçalves, William Borges Domingues, Lucas Petitemberte de Souza, Mariana B. Michalowski, Vinicius F. Campos
- 机构：Universidade Federal de Pelotas, Hospital de Clínicas de Porto Alegre
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.01307v1) · [PDF](https://arxiv.org/pdf/2607.01307v1)

## TLDR
This paper presents a novel machine learning method combining Sparse Random Projection and multinomial logistic regression for DNA methylation-based central nervous system tumor classification, achieving clinically significant improvements in accuracy over the prior state-of-the-art.
