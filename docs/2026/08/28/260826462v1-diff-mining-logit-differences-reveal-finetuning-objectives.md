...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.26462v1) · [PDF](https://arxiv.org/pdf/2608.26462v1)

## TLDR
Diff Mining reveals what a finetuned model has learned by comparing its output logits to those of its base model—extracting salient, amplified tokens that fingerprint the finetuning objectives without needing model internals.
