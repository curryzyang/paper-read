...
## TLDR
Marginal conformal prediction achieves its global coverage target but severely under-covers the minority class in imbalanced molecular datasets, and class-conditional (Mondrian) conformal prediction restores per-class reliability.
