...
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.22545v1) · [PDF](https://arxiv.org/pdf/2607.22545v1)

## TLDR
Semalith v1.4 is a 184M-parameter safety classifier that achieves state-of-the-art prompt-injection detection and regulatory compliance across three axes in a single pass, outperforming Llama-Guard-3-8B on all prompt-injection benchmarks with 44× fewer parameters.
