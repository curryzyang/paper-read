...
- 机构：Virginia Tech
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.27545v1) · [PDF](https://arxiv.org/pdf/2608.27545v1)

## TLDR
VR teleoperation of a greenhouse robot can inspect leaves and assess soil moisture, but reliability is primarily limited by camera occlusion from dense plant canopies rather than operator skill or interface experience.
