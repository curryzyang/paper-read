...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.04084v1) · [PDF](https://arxiv.org/pdf/2608.04084v1)

## TLDR
SpecDrop shows that a fixed, parameter-free category-conditioned routing scheme can match or beat learned routers on aligned vision tasks, revealing that alignment between training-signal granularity and target categories—not the routing algorithm—determines when modular specialization helps.
