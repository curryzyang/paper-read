...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.28905v1) · [PDF](https://arxiv.org/pdf/2608.28905v1)

## TLDR
Using the semantic ID code hierarchy of a generative recommender as a coarse action abstraction for off-policy evaluation restores support and reduces error where per-item evaluation is infeasible, though the benefit stems from coarsening itself, with the hierarchy making such coarsening feasible and its depth serving as a tunable bias-variance knob.
