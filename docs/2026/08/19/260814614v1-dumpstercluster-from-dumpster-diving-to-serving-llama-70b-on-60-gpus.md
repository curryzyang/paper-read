...
- 机构：Quettaflop AI, University of Oxford, University of Cambridge
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.14614v1) · [PDF](https://arxiv.org/pdf/2608.14614v1)

## TLDR
A 128-GPU cluster built entirely from second-hand V100s can serve LLaMA-70B at a fraction of the cost of new hardware, but its economic and environmental viability depends heavily on access to cheap, low-carbon electricity.
