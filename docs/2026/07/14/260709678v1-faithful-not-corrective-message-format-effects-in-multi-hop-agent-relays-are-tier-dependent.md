...
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.09678v1) · [PDF](https://arxiv.org/pdf/2607.09678v1)

## TLDR
Message-format effects in multi-hop LLM agent relays are tier-dependent: for strong relays they are nearly lossless with cost only increasing under cognitive load, while for weak relays they produce large fidelity differences that flip in transit, because structure provides a faithful, error-localizing channel rather than an error-correcting code.
