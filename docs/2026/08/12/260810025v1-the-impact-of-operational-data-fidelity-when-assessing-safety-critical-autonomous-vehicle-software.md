...
- 链接：[arXiv / Source](http://arxiv.org/abs/2608.10025v1) · [PDF](https://arxiv.org/pdf/2608.10025v1)

## TLDR
Insufficiently detailed operational data can make reliability claims for safety-critical autonomous-vehicle software dangerously optimistic, and this paper extends conservative Bayesian inference to quantify, for the first time, how much this low data fidelity undermines such assessments.
