...
- 机构：Mittweida University of Applied Sciences
- 链接：[arXiv / Source](http://arxiv.org/abs/2609.09257v1) · [PDF](https://arxiv.org/pdf/2609.09257v1)

## TLDR
This paper proposes a staged, uncertainty-aware, and accountable evaluation protocol for sensor-based AI under distribution shift that cumulatively holds out devices, subjects, and time and judges performance by quantiles against chance references, demonstrated on smartphone-based geomagnetic localisation in two underground mines where unchanged recurrent models re-evaluated after 34 months achieved a 5% quantile precision of 0.39 (16.5× chance), showing that mean-based reporting can mislead deployment risk.
