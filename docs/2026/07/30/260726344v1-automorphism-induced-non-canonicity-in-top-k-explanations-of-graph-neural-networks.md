...
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.26344v1) · [PDF](https://arxiv.org/pdf/2607.26344v1)

## TLDR
Top-\(k\) explanations of graph neural networks are structurally non-canonical for symmetric inputs because permutation equivariance forces tied attribution scores, causing arbitrary tie-breaking that can be resolved by reporting orbits instead.
