...
- 机构：Microsoft, Shaanxi Normal University
- 链接：[arXiv / Source](http://arxiv.org/abs/2609.20904v1) · [PDF](https://arxiv.org/pdf/2609.20904v1)

## TLDR
Bio-MF is a latent-free, one-step MeanFlow framework that rapidly generates high-fidelity fNIRS from EEG (7 ms per trial, 857× faster than multi-step diffusion) to enable low-latency hybrid motor-imagery BCIs with improved decoding accuracy.
