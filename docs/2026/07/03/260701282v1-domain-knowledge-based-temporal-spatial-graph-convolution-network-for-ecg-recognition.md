...
- 机构：China Mobile Research Institute, China Mobile GBA (Greater Bay Area) Innovation Institute, Chinese Academy of Sciences, Beijing Jiaotong University, Purple Mountain Laboratory
- 链接：[arXiv / Source](http://arxiv.org/abs/2607.01282v1) · [PDF](https://arxiv.org/pdf/2607.01282v1)

## TLDR
This paper proposes a domain knowledge-based temporal-spatial graph convolution network that models intra- and inter-cycle ECG relationships using key landmarks (PRQST) within a double-stream directed graph, achieving state-of-the-art F1 scores of 88.1% overall and 76.3% on rare categories.
