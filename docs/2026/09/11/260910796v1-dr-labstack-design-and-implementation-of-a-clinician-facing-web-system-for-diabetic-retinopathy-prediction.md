...
- 链接：[arXiv / Source](http://arxiv.org/abs/2609.10796v1) · [PDF](https://arxiv.org/pdf/2609.10796v1)

## TLDR
DR-LabStack is a React–Flask clinician-facing web system that integrates four heterogeneous pretrained diabetic retinopathy prediction models via a shared feature-discovery form and backend adapters, with functional evaluation demonstrating consistent loading, inference, and result rendering, while clinical effectiveness and usability remain untested.
