...
- 链接：[arXiv / Source](http://arxiv.org/abs/2609.04277v1) · [PDF](https://arxiv.org/pdf/2609.04277v1)

## TLDR
FailureSpot introduces a label-efficient, two-stage framework for timestamp-level failure detection in vision-language-action models, using action-derived weak supervision and uncertainty-based active learning to improve both timestamp-level and trajectory-level detection accuracy while minimizing dense annotation costs.
